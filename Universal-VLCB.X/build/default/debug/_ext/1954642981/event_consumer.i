...
# 43 "../../VLCBlib_PIC/event_consumer.h"
# 1 "..\\module.h" 1
...
# 43 "../../VLCBlib_PIC/event_consumer.h" 2
...
# 57 "../../VLCBlib_PIC/event_consumer.c"
...
# 106 "../../VLCBlib_PIC/event_consumer.c"
static Processed consumerProcessMessage(Message *m) {
    uint8_t start, end;
    uint8_t tableIndex;
    int8_t change;
...
Boolean pushAction(Action a) {
    if (((awriter+1)&(16 -1)) == areader) return FALSE;
    actionQueue[awriter++] = a;
    if (awriter >= 16) awriter = 0;
    return TRUE;
}
# 236 "../../VLCBlib_PIC/event_consumer.c"
