...
# 63 "../../VLCBlib_PIC/can18_can_2.c" 2
...
# 1 "../../VLCBlib_PIC/queue.h" 1
# 48 "../../VLCBlib_PIC/queue.h"
...
# 72 "../../VLCBlib_PIC/can18_can_2.c" 2
# 94 "../../VLCBlib_PIC/can18_can_2.c"
...
static void startEnumeration(uint8_t txWaiting);
...
static uint8_t isEvent(uint8_t opc) {
    return (((opc & 0b10010000) == 0b10010000) && ((~opc & 0b00000110)== 0b00000110));
}
...
# 695 "../../VLCBlib_PIC/can18_can_2.c"
void startEnumeration(uint8_t txWaiting) {
    uint8_t i;
