...
# 73 "../../VLCBlib_PIC/event_producer.h"
extern const Service eventProducerService;


extern uint8_t happening2Event[1 +1];
...
# 92 "../../VLCBlib_PIC/event_producer.h"
...
static Processed mnsProcessMessage(Message * m) {
    ...
    switch (m->opc) {
        case OPC_QNN:
            ...
            sendMessage5(OPC_PNN, nn.bytes.hi,nn.bytes.lo, 250, MTYP_CANMIO, flags);
            return PROCESSED;
        default:
            break;
    }
