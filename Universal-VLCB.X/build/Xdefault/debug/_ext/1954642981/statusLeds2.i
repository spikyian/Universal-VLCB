...
void showStatus(StatusDisplay s) {
    switch (s) {
        ...
        case STATUS_RESET_WARNING:
            flashCounter[1] = 0;
            flashCounter[0] = 25;
            ledState[0] = FLASH_50_2HZ;
            ledState[1] = FLASH_50_2HZ;
            break;
        case STATUS_MESSAGE_RECEIVED:
            ledState[0] = SINGLE_FLICKER_ON;
            ledState[1] = ON;
            break;
        case STATUS_MESSAGE_ACTED:
            ledState[0] = LONG_FLICKER_ON;
            ledState[1] = ON;
            break;
