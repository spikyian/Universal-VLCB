...
void factoryReset(void) {
    ...
    writeNVM(EEPROM_NVM_TYPE, 0x200, 1);
...
static void poll(void) {
    ...
    if ((tickGet() - timedResponseTime.val) > 5*(62500/200)) {
        pollTimedResponse();
