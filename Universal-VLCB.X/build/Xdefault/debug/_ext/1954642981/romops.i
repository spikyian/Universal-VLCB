...
# 2 "<built-in>" 2
# 1 "../../VLCBlib_PIC/romops.c" 2
# 73 "../../VLCBlib_PIC/romops.c"
...
extern ValidTime APP_isSuitableTimeToWriteFlash(void);
# 74 "../../VLCBlib_PIC/romops.c" 2

# 1 "../../VLCBlib_PIC/hardware.h" 1
# 75 "../../VLCBlib_PIC/romops.c" 2
...
# 77 "../../VLCBlib_PIC/romops.c" 2
# 121 "../../VLCBlib_PIC/romops.c"
...
static flash_data_t * flashBuffer = (flash_data_t *)(0x3700U);

static flash_address_t flashBlock;
# 166 "../../VLCBlib_PIC/romops.c"
eeprom_data_t EEPROM_Read(eeprom_address_t index) {
# 186 "../../VLCBlib_PIC/romops.c"
