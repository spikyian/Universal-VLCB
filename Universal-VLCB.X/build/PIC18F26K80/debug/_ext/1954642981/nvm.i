...
void loadFlashBlock(void) {
    ...
    TBLPTR = flashBlock;
    TBLPTRU = 0;
# 465 "../../VLCBlib_PIC/nvm.c"
    flashFlags.asByte = 0;
}
# 476 "../../VLCBlib_PIC/nvm.c"
