...
# 79 "../../VLCBlib_PIC/ticktime.c" 2


volatile uint8_t timerExtension1,timerExtension2;
# 109 "../../VLCBlib_PIC/ticktime.c"
void initTicker(uint8_t priority) {
    uint8_t divider, i;
    ...
    timerExtension1 = 0;
    timerExtension2 = 0;
# 155 "../../VLCBlib_PIC/ticktime.c"
}
# 182 "../../VLCBlib_PIC/ticktime.c"
uint32_t tickGet(void) {
