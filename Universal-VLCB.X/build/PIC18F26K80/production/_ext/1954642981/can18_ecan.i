...
# 2 "<built-in>" 2
# 1 "../../VLCBlib_PIC/can18_ecan.c" 2
# 54 "../../VLCBlib_PIC/can18_ecan.c"
...
# 59 "../../VLCBlib_PIC/can18_ecan.c" 2




# 1 "../../VLCBlib_PIC/messageQueue.h" 1
# 50 "../../VLCBlib_PIC/messageQueue.h"
...
# 63 "../../VLCBlib_PIC/can18_ecan.c" 2
# 84 "../../VLCBlib_PIC/can18_ecan.c"
...
static Message rxBuffers[32];
static MessageQueue rxQueue;
static Message txBuffers[8];
...
# 188 "../../VLCBlib_PIC/can18_ecan.c"
static void canFactoryReset(void) {
    canId = 0;
    writeNVM(EEPROM_NVM_TYPE, 0x3FE, canId);
}
# 201 "../../VLCBlib_PIC/can18_ecan.c"
static void canPowerUp(void) {
    int temp;
...
# 262 "../../VLCBlib_PIC/can18_ecan.c"
    ...
    TXB1DLC = 0x40;
    TXB1SIDH = canPri[4] | ((canId & 0x78) >> 3);
    TXB1SIDL = TXB0SIDL;
    ...
    TXB2DLC = 0;
    TXB2SIDH = canPri[4] | ((canId & 0x78) >> 3);
    TXB2SIDL = TXB0SIDL;
...
static CanidResult setNewCanId(uint8_t newCanId) {
    if ((newCanId >= 1) && (newCanId <= 99)) {
        ...
        TXB1SIDH &= 0b11110000;
        TXB1SIDH |= ((newCanId & 0x78) >>3);
        TXB1SIDL = TXB0SIDL;

        TXB2SIDH &= 0b11110000;
        TXB2SIDH |= ((newCanId & 0x78) >>3);
        TXB2SIDL = TXB0SIDL;
