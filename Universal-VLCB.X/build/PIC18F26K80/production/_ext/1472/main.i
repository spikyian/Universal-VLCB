...
# 79 "../../VLCBlib_PIC\\event_consumer.h"
extern const Service eventConsumerService;
# 91 "../../VLCBlib_PIC\\event_consumer.h"
typedef struct {
    EventState state;
    union {
        uint8_t value;
...
# 107 "../../VLCBlib_PIC\\timedResponse.h"
...
void configIO(uint8_t i) {
    ...
    type = (uint8_t)getNV((16 + 7*(i) + 0));
    switch (type) {
        case 1:
            if (getNV((16 + 7*(i) + 1)) & 0x04) {
                setDigitalOutput(i, (uint8_t)readNVM(EEPROM_NVM_TYPE, (eeprom_address_t)((eeprom_address_t)((0x3FF -8))-25)+i));
            } else {
