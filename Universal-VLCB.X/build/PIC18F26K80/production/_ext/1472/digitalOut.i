...
# 1 "../../VLCBlib_PIC\\ticktime.h" 1
# 198 "../../VLCBlib_PIC\\ticktime.h"
...
# 36 "../../VLCBlib_PIC\\event_producer.h"
# 1 "..\\module.h" 1
...
# 36 "../../VLCBlib_PIC\\event_producer.h" 2
...
# 75 "../../VLCBlib_PIC\\event_producer.h"
...
void startDigitalOutput(uint8_t io, uint8_t state) {
    ...
    if (state == 3) {
        flashDelays[io] = (int8_t)getNV((16 + 7*(io) + 3));
        pulseDelays[io] = 1;
        setOutputPin(io, ! getNV((16 + 7*(io) + 1) & 0x20));
        writeNVM(EEPROM_NVM_TYPE, (eeprom_address_t)((eeprom_address_t)((0x3FF -8))-25)+io, state);
        sendInvertedProducedEvent(((8 + 4*(io))+0), EVENT_ON,
                getNV((16 + 7*(io) + 1)) & 0x40, TRUE, TRUE);
        return;
    }
    flashDelays[io] = 0;
    ...
    if ((actionState) && getNV((16 + 7*(io) + 2)) && (pulseDelays[io] == 0)) {
        pulseDelays[io] = (uint8_t)getNV((16 + 7*(io) + 2));


        writeNVM(EEPROM_NVM_TYPE, ((eeprom_address_t)((0x3FF -8))-25)+io, 2);
    } else {
        pulseDelays[io] = 1;
        writeNVM(EEPROM_NVM_TYPE, ((eeprom_address_t)((0x3FF -8))-25)+io, actionState?1:2);
    }
    ...
    if (getNV((16 + 7*(io) + 1)) & 0x08) {
        if (actionState) {
            ...
            sendInvertedProducedEvent(((8 + 4*(io))+0), actionState?EVENT_ON:EVENT_OFF,
                    getNV((16 + 7*(io) + 1)) & 0x40, TRUE, TRUE);
        }
    } else {
