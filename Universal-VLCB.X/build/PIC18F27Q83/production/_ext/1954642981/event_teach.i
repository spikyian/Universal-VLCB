...
# 919 "../../VLCBlib_PIC/event_teach.c"
    return 0xff;
}
# 930 "../../VLCBlib_PIC/event_teach.c"
...
# 1010 "../../VLCBlib_PIC/event_teach.c"
int16_t getEv(uint8_t tableIndex, uint8_t evNum) {
    EventTableFlags f;
    if ( ! validStart(tableIndex)) {
...
# 1111 "../../VLCBlib_PIC/event_teach.c"
uint16_t getNN(uint8_t tableIndex) {
    uint16_t hi;
    uint16_t lo;
    EventTableFlags f;
...
# 1132 "../../VLCBlib_PIC/event_teach.c"
uint16_t getEN(uint8_t tableIndex) {
    uint16_t hi;
    uint16_t lo;
...
# 1154 "../../VLCBlib_PIC/event_teach.c"
static uint8_t evtIdxToTableIndex(uint8_t evtIdx) {
    return evtIdx - 1;
}
...
# 1205 "../../VLCBlib_PIC/event_teach.c"
...
void rebuildHashtable(void) {
    ...
    for (tableIndex=0; tableIndex<255; tableIndex++) {
        if (validStart(tableIndex)) {
            int16_t ev;
# 1256 "../../VLCBlib_PIC/event_teach.c"
