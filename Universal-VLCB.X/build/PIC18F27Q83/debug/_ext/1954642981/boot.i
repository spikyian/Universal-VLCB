...
const uint8_t paramBlock[] __attribute__((address(0x820))) = {
    ...
    0,
    0,
    ((MANU_MERG+'e'+MTYP_CANMIO+255 +20 +(15+7*16)+3 +(8) +P18F26K80+(8)+CPUM_MICROCHIP+3 +(20)+(0x48)+(0x08)+1 +2 +PB_CAN)&0xFF),
    ((MANU_MERG+'e'+MTYP_CANMIO+255 +20 +(15+7*16)+3 +(8) +P18F26K80+(8)+CPUM_MICROCHIP+3 +(20)+(0x48)+(0x08)+1 +2 +PB_CAN)>>8)
};
