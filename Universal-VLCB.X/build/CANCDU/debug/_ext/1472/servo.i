...
ServoState servoState[14];
uint8_t currentPos[14];
uint8_t targetPos[14];
uint8_t stepsPerPollSpeed[14];
uint8_t pollsPerStepSpeed[14];
uint8_t pollCount[14];
int speed[14];
uint8_t loopCount[14];
# 117 "../servo.c"
TickValue ticksWhenStopped[14];
...
void __attribute__((picinterrupt(("irq(TMR3), base(0x900)")))) TMR3_ISR(void)
{
