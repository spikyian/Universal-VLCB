...
extern ServoState servoState[14];
extern uint8_t currentPos[14];
extern uint8_t targetPos[14];
extern uint8_t stepsPerPollSpeed[14];
extern int speed[14];
...
uint8_t APP_nvDefault(uint8_t index) {
    ...
    return channelDefaultNVs[(((uint8_t)((index-16)/7)) < 8) ? 7 : 0][(index-16) % 7];
}
