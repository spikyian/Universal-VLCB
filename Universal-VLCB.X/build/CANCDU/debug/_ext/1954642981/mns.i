...
const char name[] __attribute__((address(0x848))) = "CDU    ";
...
static Processed mnsProcessMessage(Message * m) {
    ...
    if (mode_state == MODE_SETUP) {
        switch (m->opc) {
            ...
            case OPC_RQMN:
                ...
                return PROCESSED;
            case OPC_QNN:
                sendMessage5(OPC_PNN, 0,0, MANU_MERG, MTYP_CANCDU, getParameterFlags());
                return PROCESSED;
            default:
                break;
        }
    ...
    switch (m->opc) {
        case OPC_QNN:
            sendMessage5(OPC_PNN, nn.bytes.hi,nn.bytes.lo, MANU_MERG, MTYP_CANCDU, getParameterFlags());
            return PROCESSED;
